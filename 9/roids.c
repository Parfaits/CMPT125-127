...
const unsigned int ROID_LIFETIME = 20; // roid splits this many times
...
void ship_draw( const ship_t* ship )
{
  ...
  */
  /*if(ship->x  && ship->thrust)
  {
    draw_triangle( ship->x - dx);
  }*/
  if( ship->size+ship->x >= 1 && ship->y+ship->size >= 1 )
  {
  ...
  } else if ( ship->x-ship->size <= 0 && ship->y-ship->size <= 0 )
  {
    draw_triangle( (ship->x+1) + dx, (ship->y+1) + dy,
     (ship->x+1) + lx, (ship->y+1) + ly,
     (ship->x+1) + rx, (ship->y+1) + ry,
  ...
  } else if ( ship->size+ship->x >= 1 && ship->y-ship->size <= 0 )
  {
    draw_triangle( (ship->x-1) + dx, (ship->y+1) + dy,
     (ship->x-1) + lx, (ship->y+1) + ly,
     (ship->x-1) + rx, (ship->y+1) + ry,
  ...
  } else if ( ship->x-ship->size <= 0 && ship->y+ship->size >= 1 )
  {
    draw_triangle( (ship->x+1) + dx, (ship->y-1) + dy,
     (ship->x+1) + lx, (ship->y-1) + ly,
     (ship->x+1) + rx, (ship->y-1) + ry,
...
{
  float color[4] = {drand48(),drand48(),drand48(),drand48()}; // white 
...
void roid_draw( const roid_t* roid )
{
  ...
  */
  //printf("%f  %f\n", roids->x, roids->y);
  //printf("%f  %f\n", roid->width, roid->height);

  /*if( roid->x+(4.0*roid->width*roid->height) >= 1 && roid->y+(4.0*roid->width*roid->height) >= 1 )
  {
    draw_rectangle( (roid->x-1)-roid->width/2.0, (roid->y-1)-roid->height/2.0, 
      (roid->x-1)+roid->width/2.0, (roid->y-1)+roid->height/2,
      roid->color );
  } else if ( roid->x-(4.0*roid->width*roid->height) <= 0 && roid->y-(4.0*roid->width*roid->height) <= 0 )
  {
    draw_rectangle( (roid->x+1)-roid->width/2.0, (roid->y+1)-roid->height/2.0, 
      (roid->x+1)+roid->width/2.0, (roid->y+1)+roid->height/2,
      roid->color );
  } else if ( roid->x+(4.0*roid->width*roid->height) >= 1 && roid->y-(4.0*roid->width*roid->height) <= 0 )
  {
    draw_rectangle( (roid->x-1)-roid->width/2.0, (roid->y+1)-roid->height/2.0, 
      (roid->x-1)+roid->width/2.0, (roid->y+1)+roid->height/2,
      roid->color );
  } else if ( roid->x-(4.0*roid->width*roid->height) <= 0 && roid->y+(4.0*roid->width*roid->height) >= 1 )
  {
    draw_rectangle( (roid->x+1)-roid->width/2.0, (roid->y-1)-roid->height/2.0, 
      (roid->x+1)+roid->width/2.0, (roid->y-1)+roid->height/2,
      roid->color );
  }
  if( roid->x+(4.0*roid->width*roid->height) >= 1 )
  {
    draw_rectangle( (roid->x-1)-roid->width/2.0, roid->y-roid->height/2.0, 
      (roid->x-1)+roid->width/2.0, roid->y+roid->height/2,
      roid->color );
  }
  if( roid->x-(4.0*roid->width*roid->height) <= 0 )
  {
    draw_rectangle( (roid->x+1)-roid->width/2.0, roid->y-roid->height/2.0, 
      (roid->x+1)+roid->width/2.0, roid->y+roid->height/2,
      roid->color );
  }
  if( roid->y+(4.0*roid->width*roid->height) >= 1 )
  {
    draw_rectangle( roid->x-roid->width/2.0, (roid->y-1)-roid->height/2.0, 
      roid->x+roid->width/2.0, (roid->y-1)+roid->height/2,
      roid->color );
  }
  if( roid->y-(4.0*roid->width*roid->height) <= 0 )
  {
    draw_rectangle( roid->x-roid->width/2.0, (roid->y+1)-roid->height/2.0, 
      roid->x+roid->width/2.0, (roid->y+1)+roid->height/2,
      roid->color );
  }*/
  if( roid->x+(roid->width) >= 1 && roid->y+(roid->height) >= 1 )
  {
    draw_rectangle( (roid->x-1)-roid->width/2.0, (roid->y-1)-roid->height/2.0, 
      (roid->x-1)+roid->width/2.0, (roid->y-1)+roid->height/2,
      roid->color );
  } else if ( roid->x-(roid->width) <= 0 && roid->y-(roid->height) <= 0 )
  {
    draw_rectangle( (roid->x+1)-roid->width/2.0, (roid->y+1)-roid->height/2.0, 
      (roid->x+1)+roid->width/2.0, (roid->y+1)+roid->height/2,
      roid->color );
  } else if ( roid->x+(roid->width) >= 1 && roid->y-(roid->height) <= 0 )
  {
    draw_rectangle( (roid->x-1)-roid->width/2.0, (roid->y+1)-roid->height/2.0, 
      (roid->x-1)+roid->width/2.0, (roid->y+1)+roid->height/2,
      roid->color );
  } else if ( roid->x-(roid->width) <= 0 && roid->y+(roid->height) >= 1 )
  {
    draw_rectangle( (roid->x+1)-roid->width/2.0, (roid->y-1)-roid->height/2.0, 
      (roid->x+1)+roid->width/2.0, (roid->y-1)+roid->height/2,
      roid->color );
  }
  if( roid->x+(roid->width) >= 1 )
  {
    draw_rectangle( (roid->x-1)-roid->width/2.0, roid->y-roid->height/2.0, 
      (roid->x-1)+roid->width/2.0, roid->y+roid->height/2,
      roid->color );
  }
  if( roid->x-(roid->width) <= 0 )
  {
    draw_rectangle( (roid->x+1)-roid->width/2.0, roid->y-roid->height/2.0, 
      (roid->x+1)+roid->width/2.0, roid->y+roid->height/2,
      roid->color );
  }
  if( roid->y+(roid->height) >= 1 )
  {
    draw_rectangle( roid->x-roid->width/2.0, (roid->y-1)-roid->height/2.0, 
      roid->x+roid->width/2.0, (roid->y-1)+roid->height/2,
      roid->color );
  }
  if( roid->y-(roid->height) <= 0 )
  {
    draw_rectangle( roid->x-roid->width/2.0, (roid->y+1)-roid->height/2.0, 
      roid->x+roid->width/2.0, (roid->y+1)+roid->height/2,
      roid->color );
...
int shot_roid_hit( const shot_t* shot, const roid_t* roid )
{
  ...
  /* TODO: modify this code so it takes into account the toroidal
     shape of the world.
   */
  //printf("%f  %f\n", roid->x - roid->width/2, roid->y - roid->height/2);

  /*if( (roid->x - roid->width/2) <= 0 && (roid->y - roid->height/2) <= 0 )
  {
    return( (shot->x >= (roid->x+1) - roid->width/2 ||
        shot->x <= roid->x + roid->width/2) &&
    (shot->y >= (roid->y+1) - roid->height/2 ||
         shot->y <= roid->y + roid->height/2) );
  }
  if( (roid->x + roid->width/2) >= 1 && (roid->y + roid->height/2) >= 1 )
  {
  ...
  if( (roid->x + roid->width/2) >= 1 && (roid->y + roid->height/2) <= 0 )
  {
    return( (shot->x >= roid->x - roid->width/2 ||
        shot->x <= (roid->x-1) + roid->width/2) &&
    (shot->y >= (roid->y+1) - roid->height/2 ||
  ...
  if( (roid->x - roid->width/2) <= 0 && (roid->y - roid->height/2) >= 1 )
  {
    return( (shot->x >= (roid->x+1) - roid->width/2 ||
        shot->x <= roid->x + roid->width/2) &&
    (shot->y >= roid->y - roid->height/2 ||
  ...
  {
    return( shot->y >= roid->x - roid->width/2 &&
    shot->x <= roid->x + roid->width/2 &&
    (shot->y >= (roid->y+1) - roid->height/2 ||
         shot->y <= roid->y + roid->height/2) );
  }
  ...
  for (int i = -1; i <= 1; ++i)
  {
    for (int j = -1; j <= 1; ++j)
    {
      int b = ((shot->x >= (roid->x+i) - roid->width/2 &&
                shot->x <= (roid->x+i) + roid->width/2) &&
          (shot->y >= (roid->y+j) - roid->height/2 &&
                    shot->y <= (roid->y+j) + roid->height/2));
      a = a||b;
    }
  }
